/// ogre animation for smart logic
    ...
    if (object_exists(object_player) && distance_to_object(object_player)<15 && irandom(5)==0 && enemy_canSlash && isfrozen == false){
    ...
    else if (enemy_canSlash && object_exists(object_player && isfrozen == false)){
         // backhand slash check
